...
exports.forgotPassword = async (req, res) => {
	...
	try {
		...
		const resetPasswordUrl = `http://18.205.10.114:3000/password-reset/${resetPasswordToken}`
...
exports.adminForgotPassword = async (req, res) => {
	...
	try {
		...
		// Create reset url to email to provided email
		const resetPasswordUrl = `http://18.205.10.114:3001/password-reset/${resetPasswordToken}`
...
exports.inviteNewFriend = async (req, res) => {
	...
	try {
		...
		const message = `
            ...
            <a href="http://18.205.10.114:3000/auth" clicktracking=off>Click here</a>
        `
